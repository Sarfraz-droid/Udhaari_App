...
import 'package:udhaari/components/chats/users_list.dart';
import 'package:udhaari/services/expenses.dart';

class AddExpenseModal extends HookWidget {
  ChatModel? chat;
  Function onAddExpense;
  AddExpenseModal({super.key, this.chat, required this.onAddExpense});

  @override
  Widget build(BuildContext context) {
    final _totalAmount = useState(0);
    ...
    useEffect(() {
      print('useEffect called ${_totalAmount.value}');
      return () {
    ...
    void calculateExpense({required double total}) {
      List<ExpenseItem> expenses = ExpensesService().calculateExpense(
        ...
        total: double.parse(_totalAmount.value.toString()),
      );
    ...
    useEffect(() {
      ...
      calculateExpense(total: _totalAmount.value.toDouble());
      settleExpense();
    ...
    }, [_paidBy.value, _totalAmount.value]);
            ...
            children: [
                  ...
                  Center(
                    child: TextField(
                      ...
                      onChanged: ((value) {
                        ...
                        _totalAmount.value = int.parse(value);
                      }),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    onAddExpense(
                        _totalAmount.value, _expenses.value, _settled.value);
